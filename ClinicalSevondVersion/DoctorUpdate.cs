...
namespace ClinicalSevondVersion
{
    public partial class DoctorUpdate : UserControl
    {
        ...
        {
            conn.Open();
            SqlCommand cmd1 = new SqlCommand("SELECT * from Drsignup WHERE ID='" + textBox2.Text + "'", conn);
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("UPDATE Drsignup SET Name=@Name,Email=@Email," +
                    "Mobile=@Mobile," +
